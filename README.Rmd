...
``` {r plot-weightclass, message = FALSE}
...
``` {r plot-coordination, message = FALSE}
...
``` {r plot-acrobatic, message = FALSE}
...
``` {r fonts-and-plot-one, message = FALSE}
